...
export class ImageCropperComponent {
  ...
  constructor(private sanitizer:DomSanitizer,private profileService:ProfileService){
    ...
    this.fileEvent.emit("sadasdasd");
    this.profileService.panfileEventData.subscribe((event:any)=>{
      console.log("sub data in child",event);
      this.imageChangedEvent = event;
    })
    console.log(this.fileUploadData,"dqewwqeqweqweqwe")
  }
  ...
  imageCropped(event: ImageCroppedEvent) {
    ...
    this.fileEvent.emit(this.croppedImage);
    console.log(event);
  }
  ...
  save(){
    console.log('Image loaded',this.finalImg);
    $('#imageViewer').modal('hide');
    this.fileEvent.emit(this.finalImg)
  }
  ...
  cropperReady(sourceImageDimensions: Dimensions) {
    ...
    this.loading = false;
    this.croppedImage = sourceImageDimensions;
  }
